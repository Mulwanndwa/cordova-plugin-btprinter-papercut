...
var BTPrinter = {
    ...
    cutPaper: function (fnSuccess, fnError, system, data, align, position, font, height) {
        exec(fnSuccess, fnError, "BluetoothPrinter", "cutPaper", [system, data, align, position, font, height]);
    }
};
